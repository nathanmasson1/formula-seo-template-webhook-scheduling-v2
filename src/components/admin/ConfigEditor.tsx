    ...
    const handleSave = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (pendingFooterLogo) {
                triggerToast('Enviando logo do rodapé...', 'progress', 40);
            ...
            setFileSha(res.sha); setPendingLogo(null); setPendingFooterLogo(null); setPendingFavicon(null);
    ...
    return (
        <form onSubmit={handleSave} className="space-y-8 pb-32 max-w-3xl">
            ...
            <div className="p-8 bg-white border border-slate-200 rounded-2xl shadow-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="md:col-span-2 grid grid-cols-1 sm:grid-cols-3 gap-8 items-start">
                        ...
                        <div className="w-full">
                            <label className={labelClass}>Logo do Rodapé</label>
                            <label className="group relative border-2 border-dashed border-slate-300 hover:border-violet-500 bg-slate-900 hover:bg-slate-800 rounded-2xl p-6 flex flex-col items-center justify-center cursor-pointer transition-all text-center h-48">
                                ...
                                {config?.footerLogo ? (
                                    <img src={config.footerLogo} alt="Logo do rodapé" className="max-h-24 w-auto object-contain mb-4 group-hover:scale-105 transition-transform" />
                                ) : (
                                ...
                                <span className="text-sm font-semibold text-white group-hover:text-violet-200 transition-colors">
                                    {config?.footerLogo ? 'Trocar Logo do Rodapé' : 'Enviar Logo do Rodapé'}
                                </span>
            ...
            <div id="ai" className="p-8 bg-white border border-slate-200 rounded-2xl shadow-sm scroll-mt-8">
                ...
                <p className="text-sm text-slate-500 mb-6 border-b border-slate-100 pb-4">Configure o OpenAI para gerar artigos de blog SEO em massa.</p>
                <div className="space-y-4">
