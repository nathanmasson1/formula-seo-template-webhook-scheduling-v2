...
import {
    LayoutDashboard, FileText, Tag, Users, Home, Info, Phone, Link as LinkIcon,
    Shield, Settings, LogOut, ChevronRight, ExternalLink, Navigation,
    Sparkles, Layout, Star, Wand2, MonitorSmartphone,
} from 'lucide-react';
...
const mainItems: NavItem[] = [
    ...
    { label: 'Gerador SEO em Massa', href: '/admin/reviews/new', icon: Wand2, section: 'reviews', highlight: true },
...
const pageItems: NavItem[] = [
    ...
    { label: 'Backlinks', href: '/admin/backlinks', icon: LinkIcon, section: 'backlinks' },
    { label: 'Criação de Sites', href: '/admin/criacao-de-sites', icon: MonitorSmartphone, section: 'criacao-de-sites' },
